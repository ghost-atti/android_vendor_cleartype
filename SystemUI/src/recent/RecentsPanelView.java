...
public class RecentsPanelView extends FrameLayout implements OnItemClickListener, RecentsCallback,
    ...
    private final Runnable updateRamBarTask = new Runnable() {
        ...
        public void run() {
            ...
            sizeStr = Formatter.formatShortFileSize(mContext, totalMem);
            mTotalRamText.setText(getResources().getString(
                    R.string.total_ramm, sizeStr));
    ...
    public void updateSettings() {
        ...
        if (ramBarEnabled) {
            if (mRamUsageBar != null) {
                ...
                mTotalRamText = (TextView) findViewById(R.id.TotalramText);
            } else {
